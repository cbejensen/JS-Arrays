...
function finder() {
    ...
    return "The number is " + getRandomArbitrary() + " so your result is " + result;
}
...
*/
  ...
  //Code Here
function removeItem(myGroceryList, removal) {
    for (var i = 0; i < myGroceryList.length; i++) {
        if (myGroceryList[i] === removal) {
...
function addItem(myGroceryList, addition) {
    myGroceryList.push(addition);
    return myGroceryList;
}

alert(removeItem(myGroceryList, 'chips'));
alert(addItem(myGroceryList, 'mulk'));
...
function longest(arr1, arr2) {
	...
	alert("The second array is: " + arr2);
  		if (arr1.length > arr2.length) {
    		return "The first array is longest!";
  		} else {
  			return "The second array is longest!";
        }
}
...
var user2 = {
    ...
    password: 'iAmShort',
    username: 'shortestGuy'
};
var user3 = {
    name: 'Fatty',
    email: 'fatso@yahoo.com',
    password: '0001',
    username: 'phat'
};
